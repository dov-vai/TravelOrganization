DROP TABLE
IF
  EXISTS keliones_marsruto_dalys;
  DROP TABLE
  IF
    EXISTS keliones;
    DROP TABLE
          ...
          IF
            ...
            IF
              ...
              IF
                ...
                DROP TABLE
                IF
                  EXISTS marsruto_stoteles;
                  DROP TABLE
                  IF
                    EXISTS stoteles;
                    DROP TABLE
                    IF
                      EXISTS uzsakymo_busenos;
                      DROP TABLE
                      IF
                        EXISTS marsrutai;
                        DROP TABLE
                        IF
                          ...
                          DROP TABLE
                          IF
                            EXISTS korteles_tipai;
                            CREATE TABLE korteles_tipai (id int, name text NOT NULL, PRIMARY KEY(id));
                            INSERT INTO
                              korteles_tipai(id, name)
                            VALUES
                              (1, 'Mastercard');
                            INSERT INTO
                              korteles_tipai(id, name)
                            ...
                            CREATE TABLE roles (id int, name text NOT NULL, PRIMARY KEY(id));
                            INSERT INTO
                              roles(id, name)
                            VALUES
                              (1, 'Klientas');
                            ...
                            CREATE TABLE uzsakymo_busenos (id int, name text NOT NULL, PRIMARY KEY(id));
                            INSERT INTO
                              uzsakymo_busenos(id, name)
                            VALUES
                              (1, 'Pateiktas');
                            INSERT INTO
                              uzsakymo_busenos(id, name)
                            ...
                            CREATE TABLE vartotojai (
                              ...
                              , role int NOT NULL
                              , id int NOT NULL
                              , pastas_patvirtintas BOOLEAN DEFAULT 0
                              , patvirtinimo_kodas TEXT NOT NULL
                              , kodo_galiojimas TEXT NOT NULL
                              , PRIMARY KEY(id)
                            ...
                            CREATE TABLE keliones_marsruto_dalys (
                              ...
                              , CONSTRAINT prasideda FOREIGN KEY(
                                fk_Marsruto_stotele_1
                                , fk_Marsruto_stotele_eil_nr1
                              ) REFERENCES marsruto_stoteles (eil_nr, fk_Marsrutas_nr)
